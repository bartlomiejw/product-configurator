...
/******/ 			var chunk = require("./" + ({"1":"pages/home","2":"pages/index","3":"pages/konfigurator","4":"pages/lista","5":"pages/login","6":"pages/maxstone-konfigurator"}[chunkId]||chunkId) + ".js");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var graphql_tag__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(10);
...
/* harmony default export */ __webpack_exports__["default"] = (async function ({
  ...
  try {
    ...
    return redirect('/konfigurator'); //we are good to go and validated  
  } catch (e) {
    //token is not valid
    //logout user to clear storage
    try {
      const result = await app.$apolloHelpers.onLogout(); //redirect them to login page
...
const middleware = {};
middleware['authenticated'] = __webpack_require__(30);
...
const _ad0c5206 = () => interopDefault(__webpack_require__.e(/* import() | pages/home */ 1).then(__webpack_require__.bind(null, 94)));

const _0327a96a = () => interopDefault(__webpack_require__.e(/* import() | pages/konfigurator */ 3).then(__webpack_require__.bind(null, 95)));

const _7d907356 = () => interopDefault(__webpack_require__.e(/* import() | pages/lista */ 4).then(__webpack_require__.bind(null, 96)));

const _b8b4218a = () => interopDefault(__webpack_require__.e(/* import() | pages/login */ 5).then(__webpack_require__.bind(null, 97)));

const _8c99526a = () => interopDefault(__webpack_require__.e(/* import() | pages/maxstone-konfigurator */ 6).then(__webpack_require__.bind(null, 98)));

const _4c0367b8 = () => interopDefault(__webpack_require__.e(/* import() | pages/index */ 2).then(__webpack_require__.bind(null, 99))); // TODO: remove in Nuxt 3
...
var external_vue_apollo_ = __webpack_require__(9);
...
var external_apollo_cache_inmemory_ = __webpack_require__(4);
...
/* harmony default export */ var apollo_module = ((ctx, inject) => {
  ...
  if (true) {
    const ApolloSSR = __webpack_require__(38);
  ...
  const app = {
    head: {
      ...
      "link": [{
        ...
        "rel": "stylesheet",
        "href": "https:\u002F\u002Ffonts.googleapis.com\u002Fcss2?family=Encode+Sans:wght@400;900&display=swap"
      }],
      "style": [],
      "script": []
    },
